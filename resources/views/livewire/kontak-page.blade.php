                        ...
                        <div class="bg-[#6B9B55] text-white rounded-lg p-6" style="border-radius: 0px 20px 20px 0px;">
                            <div class="max-w-full mx-auto rounded-lg overflow-hidden">
                                ...
                                <div class="border-t border-gray-200 px-6 py-4">
                                    <h3 class="text-lg font-medium">Jam Kerja</h3>
                                    <p class="mt-1">Senin - Jumat: 9am - 5pm</p>
                                    <p class="mt-1">Sabtu: 10am - 4pm</p>
                                    <p class="mt-1">Minggu: Tutup</p>
                                </div>
                                <div class="border-t border-gray-200 px-6 py-4">
                                    <h3 class="text-lg font-medium">Kontak</h3>
                                    <p class="mt-1">Email: info@example.com</p>
                                    <p class="mt-1">Telepon: +1 23494 34993</p>
                                </div>
                            </div>
                        </div>
                    </div>

        ...
        @if($programs->count())
            <div data-aos="fade-up" class="flex flex-wrap justify-center gap-4">
                @foreach ($programs as $program)
                    <div class="max-w-sm w-full sm:w-1/2 lg:w-1/4 mx-4 my-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col">
